# coding:utf-8
"""
Django settings for eclec project.
...
SECRET_KEY = '$rnb_rp3h@atj=0z(_y(q#_9^fy)1$f29x3uzq5z-69)a%h%tm'
...
WSGI_APPLICATION = 'eclec.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(os.path.dirname(BASE_DIR), 'eclec', 'templates', 'public'),
)
